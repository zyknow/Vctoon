...
const comicId = computed(() => route.params.id as string | undefined)
...
const handleHelp = async () => {
  toast.add({
    title: $t('page.comic.messages.help'),
    color: 'info',
  })
...
const fetchComic = async () => {
  ...
  try {
    ...
    toast.add({
      title: $t('page.comic.messages.loadFailed'),
      color: 'error',
    })
  } finally {
...
<template>
  ...
  >
    <transition name="fade-fast">
      ...
      >
        ...
        <div class="flex items-center gap-2">
          <UTooltip :text="$t('page.comic.actions.settings')">
            <UButton
              square
              variant="ghost"
              class="text-white"
          ...
          <UTooltip :text="$t('page.comic.actions.help')">
            <UButton
              square
              variant="ghost"
              class="text-white"
    ...
    <transition name="fade-fast">
      ...
      >
        <div class="flex items-center gap-2">
          <UTooltip :text="$t('page.comic.actions.firstPage')">
            <UButton
              square
              variant="ghost"
              class="text-white"
        ...
        <div class="flex items-center gap-2">
          <UTooltip :text="$t('page.comic.actions.lastPage')">
            <UButton
              square
              variant="ghost"
              class="text-white"
