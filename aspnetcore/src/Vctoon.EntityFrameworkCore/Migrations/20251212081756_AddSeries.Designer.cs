...
namespace Vctoon.Migrations
{
    ...
    [Migration("20251212081756_AddSeries")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppMediumArtists", b =>
                {
                    ...
                    b.HasKey("MediumId", "ArtistId");

                    b.HasIndex("ArtistId");

                    b.ToTable("AppMediumArtists", (string)null);
                });

            modelBuilder.Entity("AppMediumTags", b =>
                {
                    b.Property<Guid>("MediumId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMediumTags", (string)null);
                });
            ...
            modelBuilder.Entity("Vctoon.Libraries.ArchiveInfo", b =>
                {
                    ...
                    b.ToTable("AppArchiveInfos", (string)null);
                });
            ...
            modelBuilder.Entity("Vctoon.Libraries.ArchiveInfoPath", b =>
                {
                    ...
                    b.ToTable("AppArchiveInfoPaths", (string)null);
                });
            ...
            modelBuilder.Entity("Vctoon.Libraries.ComicImage", b =>
                {
                    ...
                    b.ToTable("AppImageFiles", (string)null);
                });
            ...
            modelBuilder.Entity("Vctoon.Libraries.LibraryPath", b =>
                {
                    ...
                    b.ToTable("AppLibraryPaths", (string)null);
                });

            modelBuilder.Entity("Vctoon.Libraries.LibraryPermission", b =>
                {
                    b.Property<Guid>("LibraryId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppLibraryPermissions", (string)null);
                });
            ...
            modelBuilder.Entity("Vctoon.Mediums.MediumSeriesLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SeriesId", "MediumId")
                        .IsUnique();

                    b.HasIndex("SeriesId", "Sort");

                    b.ToTable("AppMediumSeriesLinks", (string)null);
                });
            ...
            modelBuilder.Entity("AppMediumArtists", b =>
                {
                    b.HasOne("Vctoon.Libraries.Artist", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Vctoon.Mediums.MediumSeriesLink", b =>
                {
                    b.HasOne("Vctoon.Mediums.Medium", "Medium")
                        .WithMany("SeriesLinks")
                        .HasForeignKey("MediumId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Vctoon.Mediums.Medium", "Series")
                        .WithMany("ItemLinks")
