        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifyTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastResolveTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LibraryId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLibraryPaths", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppLibraryPaths_AppLibraries_LibraryId",
                        column: x => x.LibraryId,
                        principalTable: "AppLibraries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanStar = table.Column<bool>(type: "boolean", nullable: false),
                    CanView = table.Column<bool>(type: "boolean", nullable: false),
                    CanShare = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLibraryPermissions", x => new { x.LibraryId, x.UserId });
                    table.ForeignKey(
                        name: "FK_AppLibraryPermissions_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppArchiveInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppArchiveInfos_AppLibraryPaths_LibraryPathId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifyTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastResolveTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ArchiveInfoId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppArchiveInfoPaths", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppArchiveInfoPaths_AppArchiveInfos_ArchiveInfoId",
                        column: x => x.ArchiveInfoId,
                        principalTable: "AppArchiveInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppImageFiles", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppImageFiles_AppLibraryPaths_LibraryPathId",
                        column: x => x.LibraryPathId,
                        principalTable: "AppLibraryPaths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppArchiveInfoPaths_ArchiveInfoId",
                table: "AppArchiveInfoPaths",
                column: "ArchiveInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_AppArchiveInfos_LibraryPathId",
                table: "AppArchiveInfos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLibraryPaths_LibraryId",
                table: "AppLibraryPaths",
                column: "LibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppLibraryPermissions_UserId",
                table: "AppLibraryPermissions",
                column: "UserId");
