...
namespace Vctoon.Migrations
{
    ...
    [Migration("20240413132141_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vctoon.Comics.ComicChapter", b =>
                {
                    ...
                    b.ToTable("_ComicChapters", (string)null);
                });

            modelBuilder.Entity("Vctoon.Libraries.ComicChapterFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("_ComicChapterFavorites", (string)null);
                });

            modelBuilder.Entity("Vctoon.Libraries.ComicFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("_ComicFavorites", (string)null);
                });

            modelBuilder.Entity("Vctoon.Libraries.ComicFileFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("_ComicFileFavorites", (string)null);
                });

            modelBuilder.Entity("Vctoon.Libraries.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("_Favorites", (string)null);
                });
            ...
            modelBuilder.Entity("Vctoon.Libraries.Library", b =>
                {
                    ...
                    b.ToTable("_Libraries", (string)null);
                });
            ...
            modelBuilder.Entity("Vctoon.Libraries.LibraryPath", b =>
                {
                    ...
                    b.Property<string>("ArchiveInnerPath")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Vctoon.Comics.Comic", b =>
                {
                    b.HasOne("Vctoon.Libraries.Library", "Library")
                        .WithMany()
            ...
            modelBuilder.Entity("Vctoon.Comics.ComicChapter", b =>
                {
                    b.HasOne("Vctoon.Comics.Comic", "Comic")
                        .WithMany("Chapters")
                        .HasForeignKey("ComicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vctoon.Libraries.LibraryPath", "LibraryPath")
                        .WithMany()
            ...
            modelBuilder.Entity("Vctoon.Libraries.ComicChapterFavorite", b =>
                {
                    b.HasOne("Vctoon.Comics.ComicChapter", "ComicChapter")
                        .WithMany()
                        .HasForeignKey("ComicChapterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vctoon.Libraries.Favorite", "Favorite")
                        .WithMany("ComicChapterFavorites")
            ...
            modelBuilder.Entity("Vctoon.Libraries.LibraryPath", b =>
                {
                    ...
                    b.HasOne("Vctoon.Libraries.LibraryPath", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Vctoon.Libraries.Favorite", b =>
                {
                    b.Navigation("ComicChapterFavorites");

                    b.Navigation("ComicFavorites");

                    b.Navigation("ComicFileFavorites");
                });
