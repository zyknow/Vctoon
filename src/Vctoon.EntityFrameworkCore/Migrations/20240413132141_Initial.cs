    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Favorites", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Comics", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Comics__Libraries_LibraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchiveInnerPath = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__LibraryPaths", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ComicFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK__ComicFavorites__Comics_ComicId",
                        column: x => x.ComicId,
                        principalTable: "_Comics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ComicFavorites__Favorites_FavoriteId",
                        column: x => x.FavoriteId,
                        principalTable: "_Favorites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ComicChapters__LibraryPaths_LibraryPathId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ComicFileFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK__ComicFileFavorites__Favorites_FavoriteId",
                        column: x => x.FavoriteId,
                        principalTable: "_Favorites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ComicFileFavorites__LibraryPaths_LibraryPathId",
                        column: x => x.LibraryPathId,
                        principalTable: "_LibraryPaths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ComicChapterFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK__ComicChapterFavorites__ComicChapters_ComicChapterId",
                        column: x => x.ComicChapterId,
                        principalTable: "_ComicChapters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ComicChapterFavorites__Favorites_FavoriteId",
                        column: x => x.FavoriteId,
                        principalTable: "_Favorites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX__ComicChapterFavorites_ComicChapterId",
                table: "_ComicChapterFavorites",
                column: "ComicChapterId");

            migrationBuilder.CreateIndex(
                name: "IX__ComicChapterFavorites_FavoriteId",
                table: "_ComicChapterFavorites",
                column: "FavoriteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX__ComicChapters_LibraryPathId",
                table: "_ComicChapters",
                column: "LibraryPathId");

            migrationBuilder.CreateIndex(
                name: "IX__ComicFavorites_ComicId",
                table: "_ComicFavorites",
                column: "ComicId");

            migrationBuilder.CreateIndex(
                name: "IX__ComicFavorites_FavoriteId",
                table: "_ComicFavorites",
                column: "FavoriteId");

            migrationBuilder.CreateIndex(
                name: "IX__ComicFileFavorites_FavoriteId",
                table: "_ComicFileFavorites",
                column: "FavoriteId");

            migrationBuilder.CreateIndex(
                name: "IX__ComicFileFavorites_LibraryPathId",
                table: "_ComicFileFavorites",
                column: "LibraryPathId");
