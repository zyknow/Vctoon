    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__IdentityUserExtras", x => x.Id);
                    table.ForeignKey(
                        name: "FK__IdentityUserExtras_AbpUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__LibraryPermissions", x => new { x.LibraryId, x.UserId });
                    table.ForeignKey(
                        name: "FK__LibraryPermissions_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ImageFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK__ImageFiles__ArchiveInfoPaths_ArchiveInfoPathId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ImageFiles__LibraryPaths_LibraryPathId",
                        column: x => x.LibraryPathId,
                        principalTable: "_LibraryPaths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX__ArchiveInfoPaths_ArchiveInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX__IdentityUserExtras_UserId",
                table: "_IdentityUserExtras",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX__LibraryPermissions_UserId",
